...
&lt;a href="http://blog3.localhost.localdomain/wp-content/uploads/sites/8/2017/01/f878ff71.jpg"&gt;&lt;img src="http://blog3.localhost.localdomain/wp-content/uploads/sites/8/2017/01/f878ff71.jpg" alt="" width="1000" height="666" class="alignnone size-full wp-image-274" /&gt;&lt;/a&gt;&#91gallery size="full" ids="273,272,271,270"&#93&#91/simplemasonrygallery&#93</code></h3>
	...
	public function notices() {
		...
		<div class="notice notice-error is-dismissible"><ul><li>
			<?php
			esc_html_e( '"Simple Masonry Gallery" will no longer be supported. ', 'simple-masonry-gallery' );
			if ( class_exists( 'SimpleBlockGallery' ) ) {
				esc_html_e( '"Simple Block Gallery" appears to be enabled. "Simple Masonry Gallery" should be disabled and removed.', 'simple-masonry-gallery' );
			} else {
				if ( is_multisite() ) {
					$simpleblockgallery_url = network_admin_url( 'plugin-install.php?tab=plugin-information&plugin=simple-block-gallery' );
				} else {
					$simpleblockgallery_url = admin_url( 'plugin-install.php?tab=plugin-information&plugin=simple-block-gallery' );
				}
				esc_html_e( 'The next plugin is its successor. Please switch.', 'simple-masonry-gallery' );
				?>
				<a href="<?php echo esc_url( $simpleblockgallery_url ); ?>" class="page-title-action">Simple Block Gallery</a>
				<?php
			}
			?>
		</li></ul></div>
